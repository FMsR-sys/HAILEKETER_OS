...
/c/i686-elf-tools-windows/bin/i686-elf-ld -T linker.ld kernel.o vga.o io.o io_asm.o pic.o isr.o isr_asm.o paging_asm.o e820.o paging.o pmm.o -o kernel.elf
